...
import { Phone, Mail, MessageCircle, ExternalLink, Book, Users } from 'lucide-react';
  ...
  const resources = [
    {
      ...
      url: "https://docs.firstchekout.ng/api",
      icon: Book
    },
    {
      title: "Merchant Portal",
      description: "Access your dashboard, keys, and settings",
      url: "https://paymentsolutionweb.azurewebsites.net",
      icon: ExternalLink
    },
    {
      title: "Developer Community",
      description: "Connect with other developers using FirstCheckout",
    ...
    <section id="support" className="mb-16">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Our dedicated support team is here to help you succeed with FirstCheckout. Whether you need technical 
