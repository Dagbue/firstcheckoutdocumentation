...
import {  Copy, Check, Shield, Search, } from 'lucide-react';
      ...
      <section id="access-token" className="mb-16">
        ...
        <div className="mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start">
              <span className="flex-shrink-0 w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3"></span>
              <span><strong>URL:</strong> <code className="bg-gray-100 px-2 py-1 rounded text-sm">{"{{IdenityServerAddress}}"}api/v2/authenticate/token</code></span>
            </li>
            <li className="flex items-start">
              <span className="flex-shrink-0 w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3"></span>
              <span><strong>Content-Type:</strong> application/x-www-form-urlencoded</span>
            </li>
          </ul>
        </div>
